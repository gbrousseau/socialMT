  ...
  return (
    <div className="mb-8">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Competitor Benchmarks</h2>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Posts (30d)</th>
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">VS You</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            <tr className="hover:bg-gray-50 transition-all">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-gray-900">@competitor1</td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="font-medium">32,456</div>
                <div className="text-xs text-gray-500">+1.2% (7d)</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="font-medium">5.8%</div>
                <div className="text-xs text-gray-500">Average 6.1%</div>
              </td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button className="text-purple-600 hover:text-purple-900 mr-3" title="Compare">
                  <i className="fas fa-chart-line"></i>
                </button>
                <button className="text-gray-600 hover:text-gray-900" title="Remove">
            ...
            <tr className="hover:bg-gray-50 transition-all">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-gray-900">@topcompetitor</td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="font-medium">45,892</div>
                <div className="text-xs text-gray-500">+0.8% (7d)</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="font-medium">7.2%</div>
                <div className="text-xs text-gray-500">Average 6.5%</div>
              </td>
            ...
            <tr className="hover:bg-gray-50 transition-all">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-gray-900">@industryleader</td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="font-medium">89,123</div>
                <div className="text-xs text-gray-500">+2.1% (7d)</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="font-medium">3.9%</div>
                <div className="text-xs text-gray-500">Average 4.2%</div>
              </td>
