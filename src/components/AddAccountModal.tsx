      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md transition-all transform">
        <div className="p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-black dark:text-white">Add Social Media Account</h2>
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-black dark:text-white mb-2">Platform</label>
              <div className="grid grid-cols-3 gap-3">
                ...
                <button className="bg-gray-200 dark:bg-gray-600 p-3 rounded-lg text-gray-700 dark:text-gray-200 flex flex-col items-center">
            ...
            <div>
              <label htmlFor="accountName" className="block text-black dark:text-white mb-2">Account Handle</label>
              <input
                type="text"
                id="accountName"
            ...
            <div>
              <label htmlFor="apiKey" className="block text-black dark:text-white mb-2">API Key (Optional)</label>
              <input
                type="text"
                id="apiKey"
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              ...
              />
              <p className="text-gray-500 dark:text-gray-400 text-xs mt-1">Providing an API key enables real-time updates and detailed analytics</p>
            </div>
